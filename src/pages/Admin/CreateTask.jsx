...
const CreateTask = () => {
  ...
  const deleteTask = async () => {
    try {
      ...
      toast.success("Expose details deleted successfully");
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 mt-4">
          <div className="form-card col-span-3">
            <div className="flex justify-between items-center">
              ...
              {taskId && (
                <button
                  className="flex items-center gap-1.5 text-[13px] font-medium text-rose-500 bg-rose-50 rounded p-2 py-1 border border-rose-100 hover:border-orange-300 cursor-pointer"
