      ...
      <div className="mt-5">
        <div className="mb-4">
          <button
            ...
            className="flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-primary transition duration-150 ease-in-out px-3 py-1 rounded-md border border-transparent hover:border-slate-200">
